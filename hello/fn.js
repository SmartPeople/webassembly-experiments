...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fn.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fn.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fn.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fn.html.mem" : null;
...
var real__say_hi = asm["_say_hi"]; asm["_say_hi"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__say_hi.apply(null, arguments);
};
...
var real__max = asm["_max"]; asm["_max"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _say_hi = Module["_say_hi"] = function() { return Module["asm"]["_say_hi"].apply(null, arguments) };
var stackSave = Module["stackSave"] = function() { return Module["asm"]["stackSave"].apply(null, arguments) };
var _memset = Module["_memset"] = function() { return Module["asm"]["_memset"].apply(null, arguments) };
var _max = Module["_max"] = function() { return Module["asm"]["_max"].apply(null, arguments) };
